...
I have discovered an interest in the software that is being used, how it is being used, and how it is helping or quite often making things more difficult for the Project Manager and his team. 

I'm keen on defining the "what is lacking" in the software and processes we use these days AND give it a good crack to see if I might be able to do better.

I fnd that

-software looks dated and not intersting
-is not very much fun to use, lacks the "cool" factor
-ultimately comes short of giving the user "superpowers", by empowering them with the right data
